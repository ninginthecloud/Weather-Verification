...
forecast.table = read.table(file="E:\\UW\\autumn 2014\\RA\\code\\Data\\DATA_COAMPS\\coamps_ttl_prcp_g2_2005051100_f14.txt_nohead.gz", header = F)
...
#####
model<-Mclust(data=test,G=9,modelNames="VVV")
measure(model,G=9)
